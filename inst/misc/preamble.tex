...
\setlength\RaggedRightParindent{15pt}  % sets the paragraph indentation
...
\definecolor{Red}{rgb}{0.7,0,0}  % define red
\definecolor{Blue}{rgb}{0,0,0.8}  % define blue
...
\usepackage[hidelinks, pdflang={en-US}]{hyperref}  % support for hyperlinks
