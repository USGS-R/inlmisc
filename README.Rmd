...
A recent version of [Pandoc](https://pandoc.org/installing.html) (>= 1.12.3) is also required to running particular examples in the help documentation;
[RStudio](https://rstudio.com/products/rstudio/)
includes this so you do not need to download Pandoc if working in a RStudio integrated development environment.
The imported **webshot** package has as a dependency the external program [PhantomJS](https://phantomjs.org/),
...
The [OptiPNG](http://optipng.sourceforge.net/) program is recommended for creating word clouds,
and needs to be accessible through the command window.

To install the development version of **inlpubs**, you need to clone the repository and build from source, or run:
