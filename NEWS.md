...
- In LaTeX preamble: add **multirow** package.

- In `PrintTable` function: allow `colheadings` argument to be of class 'list',
  used to make a column header span multiple columns;
  add `subheading` argument, used to specify column subheadings.
