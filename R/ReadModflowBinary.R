...
#' It reads data from binary files generated by MODFLOW.
#'
#' @param path character.
#'   Path name of the binary file.
#' @param data.type character.
#'    Description of how the data were saved.
#'    Specify \code{"array"} for array data (such as head output) and
#'    \code{"flow"} for flow data (such as cell-by-cell flow output).
